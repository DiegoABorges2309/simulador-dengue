...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/bootstrap.bundle.min.js":[function(require,module,exports) {
var define;
...
!function (t, e) {
    ...
    const d = O(r, e.replace(v, "")),
      u = o ? function (t, e, i) {
        return function n(s) {
          ...
          for (let r = s.target; r && r !== this; r = r.parentNode) for (const a of o) if (a === r) return j(s, {
            delegateTarget: r
  ...
  const B = {
    ...
    getDataAttribute: (t, e) => $(t.getAttribute("data-bs-".concat(W(e))))
  };
  class F {
    static get Default() {
      return {};
    ...
    _mergeConfigObj(t, e) {
      ...
      return _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, this.constructor.Default), "object" == typeof i ? i : {}), o(e) ? B.getDataAttributes(e) : {}), "object" == typeof t ? t : {});
    }
    _typeCheckConfig(t) {
      ...
      for (const n of Object.keys(e)) {
        const s = e[n],
          r = t[n],
          a = o(r) ? "element" : null == (i = r) ? "".concat(i) : Object.prototype.toString.call(i).match(/\s([a-z]+)/i)[1].toLowerCase();
        if (!new RegExp(s).test(a)) throw new TypeError("".concat(this.constructor.NAME.toUpperCase(), ": Option \"").concat(n, "\" provided type \"").concat(a, "\" but expected type \"").concat(s, "\"."));
      }
      var i;
    }
  }
  ...
  class at extends z {
    ...
    _setActiveIndicatorElement(t) {
      ...
      const i = Q.findOne("[data-bs-slide-to=\"".concat(t, "\"]"), this._indicatorsElement);
  ...
  class hi extends z {
    ...
    _getConfig(t) {
      if ("object" == typeof (t = super._getConfig(t)).reference && !o(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("".concat(Qe.toUpperCase(), ": Option \"reference\" provided type \"object\" without a required \"getBoundingClientRect\" method."));
      return t;
    }
    _createPopper() {
  ...
  g(cn);
  const hn = _objectSpread(_objectSpread({}, cn.Default), {}, {
      content: "",
      offset: [0, 8],
      placement: "right",
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/bootstrap.bundle.min.js"], null)
//# sourceMappingURL=/bootstrap.bundle.min.dc02027b.js.map