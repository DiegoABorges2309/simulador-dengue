...
class Ui_objeto_inicial(object):
    def setupUi(self, objeto_inicial):
        ...
        self.f_frame_principal.setStyleSheet(
        ...
        sizePolicy.setHeightForWidth(
            self.f_panel_izquierdo.sizePolicy().hasHeightForWidth()
        )
        ...
        self.f_panel_izquierdo.setStyleSheet(
        ...
        self.f_logo.setStyleSheet(
            "image: url(:/svg/Base Logo.svg);\n"
            "border-radius: 10px;\n"
        ...
        self.pb_boton_nueva_simulacion.setStyleSheet(
            "QPushButton{\n"
            "	\n"
        ...
        self.pb_boton_historial_simulacion.setObjectName(
            "pb_boton_historial_simulacion"
        )
        ...
        self.pb_boton_iniciar_simulacion.setStyleSheet(
            "QPushButton{\n"
        ...
        sizePolicy4.setHeightForWidth(
            self.sw_panel_derecho.sizePolicy().hasHeightForWidth()
        )
        ...
        self.panel_inicial.setStyleSheet(
            "background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(232, 235, 235, 255), stop:1 rgba(253, 254, 254, 255));\n"
            "border-radius: 16px;\n"
            "border: 0px;"
        )
        ...
        sizePolicy5.setHeightForWidth(
            self.f_datos_izquierdos_vacio.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_izquierdos_vacio.setSizePolicy(sizePolicy5)
        self.f_datos_izquierdos_vacio.setStyleSheet(
            "background: none;\n" "border: 0px;"
        )
        ...
        sizePolicy6.setHeightForWidth(
            self.f_grafica_humanos.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_humanos.setSizePolicy(sizePolicy6)
        self.f_grafica_humanos.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy6.setHeightForWidth(
            self.f_grafica_total_humanos.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_total_humanos.setSizePolicy(sizePolicy6)
        self.f_grafica_total_humanos.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy7.setHeightForWidth(
            self.f_datos_simulacion.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_simulacion.setSizePolicy(sizePolicy7)
        self.f_datos_simulacion.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy8.setHeightForWidth(
            self.f_datos_central_vacio.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_central_vacio.setSizePolicy(sizePolicy8)
        self.f_datos_central_vacio.setStyleSheet(
            "background: none;\n" "border: 0px;\n" "border-radius:0px;"
        )
        ...
        sizePolicy5.setHeightForWidth(
            self.f_datos_derecho_vacio.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_derecho_vacio.setSizePolicy(sizePolicy5)
        self.f_datos_derecho_vacio.setStyleSheet(
            "background:none;\n" "border: 0px;\n" ""
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_total_mosquitos.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_total_mosquitos.setSizePolicy(sizePolicy9)
        self.f_grafica_total_mosquitos.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_expuestos.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_expuestos.setSizePolicy(sizePolicy9)
        self.f_grafica_expuestos.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_infectados.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_infectados.setSizePolicy(sizePolicy9)
        self.f_grafica_infectados.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_susceptibles.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_susceptibles.setSizePolicy(sizePolicy9)
        self.f_grafica_susceptibles.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy5.setHeightForWidth(
            self.f_datos_izquierdos_vacio_2.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_izquierdos_vacio_2.setSizePolicy(sizePolicy5)
        self.f_datos_izquierdos_vacio_2.setStyleSheet(
            "background: none;\n" "border: 0px;"
        )
        ...
        sizePolicy6.setHeightForWidth(
            self.f_grafica_humanos_3.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_humanos_3.setSizePolicy(sizePolicy6)
        self.f_grafica_humanos_3.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy6.setHeightForWidth(
            self.f_grafica_general_humano.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_general_humano.setSizePolicy(sizePolicy6)
        self.f_grafica_general_humano.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n"
            "border-radius: 16px;\n"
            "border: 1px solid rgba(162, 170, 173, 100);"
        )
        ...
        sizePolicy6.setHeightForWidth(
            self.f_grafica_total_humanos_3.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_total_humanos_3.setSizePolicy(sizePolicy6)
        self.f_grafica_total_humanos_3.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy6.setHeightForWidth(
            self.f_grafica_sistema_bombeo.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_sistema_bombeo.setSizePolicy(sizePolicy6)
        self.f_grafica_sistema_bombeo.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n"
            "border-radius: 16px;\n"
            "border: 1px solid rgba(162, 170, 173, 100);"
        )
        ...
        sizePolicy7.setHeightForWidth(
            self.f_datos_simulacion_3.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_simulacion_3.setSizePolicy(sizePolicy7)
        self.f_datos_simulacion_3.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy7.setHeightForWidth(
            self.f_datos_simulacion_4.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_simulacion_4.setSizePolicy(sizePolicy7)
        self.f_datos_simulacion_4.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n"
            "border-radius: 16px;\n"
            "border: 1px solid rgba(162, 170, 173, 100);"
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.l_ritmo_contagio_general.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_ritmo_contagio_general.setStyleSheet(
            "background: none;\n"
            "border:none;\n"
        ...
        sizePolicy1.setHeightForWidth(
            self.l_poblacion_humana_total.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_poblacion_humana_total.setStyleSheet(
            "background: none;\n"
            "border:none;\n"
            "color: rgba(44, 65, 76, 150);\n"
            "padding-right: 20px;\n"
        ...
        sizePolicy1.setHeightForWidth(
            self.l_cantidad_muertos.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_cantidad_muertos.setStyleSheet(
            "background: none;\n"
            "border:none;\n"
            "color: rgba(44, 65, 76, 150);\n"
            "padding-right: 20px;\n"
        ...
        sizePolicy1.setHeightForWidth(
            self.l_infectados_acumulados.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_infectados_acumulados.setStyleSheet(
            "background: none;\n"
            "border:none;\n"
            "color: rgba(44, 65, 76, 150);\n"
            "padding-right: 20px;\n"
        ...
        sizePolicy8.setHeightForWidth(
            self.f_datos_central_vacio_2.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_central_vacio_2.setSizePolicy(sizePolicy8)
        self.f_datos_central_vacio_2.setStyleSheet(
            "background: none;\n" "border: 0px;\n" "border-radius:0px;\n" ""
        )
        ...
        sizePolicy11.setHeightForWidth(
            self.f_frame_mapa.sizePolicy().hasHeightForWidth()
        )
        self.f_frame_mapa.setSizePolicy(sizePolicy11)
        self.f_frame_mapa.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n"
            "border-radius: 16px;\n"
            "image: url(:/svg/Subtract (1).svg);"
        )
        ...
        self.pb_retrasar.setStyleSheet(
            "QPushButton{\n"
            "	border-radius: 8px;\n"
            "	border:none;\n"
            "	background-color: rgb(255, 255, 255);\n"
        ...
        self.pb_adelantar.setStyleSheet(
            "QPushButton{\n"
            "	border-radius: 8px;\n"
            "	border:none;\n"
            "	background-color: rgb(255, 255, 255);\n"
        ...
        self.frame_42.setStyleSheet(
            "border: 1px solid rgba(162, 170, 173, 60);\n"
            "border:none;\n"
            "border-radius:10px;"
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.l_susceptibles_h.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_susceptibles_h.setStyleSheet(
            "background: none;\n" "border:none;\n" "color: rgba(44, 65, 76, 150);\n" ""
        )
        ...
        sizePolicy15.setHeightForWidth(
            self.l_expuestos_h.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_expuestos_h.setStyleSheet(
            "background: none;\n" "border:none;\n" "color: rgba(44, 65, 76, 150);\n" ""
        )
        ...
        sizePolicy15.setHeightForWidth(
            self.l_infectados_h.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_infectados_h.setStyleSheet(
            "background: none;\n" "border:none;\n" "color: rgba(44, 65, 76, 150);\n" ""
        )
        ...
        sizePolicy15.setHeightForWidth(
            self.l_recuperados.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_recuperados.setStyleSheet(
            "background: none;\n" "border:none;\n" "color: rgba(44, 65, 76, 150);\n" ""
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.l_susceptibles_m.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_susceptibles_m.setStyleSheet(
            "background: none;\n" "border:none;\n" "color: rgba(44, 65, 76, 150);\n" ""
        )
        ...
        sizePolicy15.setHeightForWidth(
            self.l_expuestos_m.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_expuestos_m.setStyleSheet(
            "background: none;\n" "border:none;\n" "color: rgba(44, 65, 76, 150);\n" ""
        )
        ...
        sizePolicy15.setHeightForWidth(
            self.l_infectados_m.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_infectados_m.setStyleSheet(
            "background: none;\n" "border:none;\n" "color: rgba(44, 65, 76, 150);\n" ""
        )
        ...
        sizePolicy5.setHeightForWidth(
            self.f_datos_derecho_vacio_2.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_derecho_vacio_2.setSizePolicy(sizePolicy5)
        self.f_datos_derecho_vacio_2.setStyleSheet(
            "background:none;\n" "border: 0px;\n" ""
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_total_mosquitos_3.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_total_mosquitos_3.setSizePolicy(sizePolicy9)
        self.f_grafica_total_mosquitos_3.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_general_mosquito.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_general_mosquito.setSizePolicy(sizePolicy9)
        self.f_grafica_general_mosquito.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n"
            "border-radius: 16px;\n"
            "border: 1px solid rgba(162, 170, 173, 100);"
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_expuestos_3.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_expuestos_3.setSizePolicy(sizePolicy9)
        self.f_grafica_expuestos_3.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_cantidad_mosquitos.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_cantidad_mosquitos.setSizePolicy(sizePolicy9)
        self.f_grafica_cantidad_mosquitos.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n"
            "border-radius: 16px;\n"
            "border: 1px solid rgba(162, 170, 173, 100);"
        )
        ...
        sizePolicy9.setHeightForWidth(
            self.f_grafica_susceptibles_3.sizePolicy().hasHeightForWidth()
        )
        self.f_grafica_susceptibles_3.setSizePolicy(sizePolicy9)
        self.f_grafica_susceptibles_3.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n" "border-radius: 16px;"
        )
        ...
        sizePolicy7.setHeightForWidth(
            self.f_datos_simulacion_5.sizePolicy().hasHeightForWidth()
        )
        self.f_datos_simulacion_5.setSizePolicy(sizePolicy7)
        self.f_datos_simulacion_5.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n"
            "border-radius: 16px;\n"
            "border: 1px solid rgba(162, 170, 173, 100);"
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.l_tasa_trans_m_h.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_tasa_trans_m_h.setStyleSheet(
            "background: none;\n"
            "border:none;\n"
            "color: rgba(44, 65, 76, 150);\n"
            "padding-right: 20px;\n"
        ...
        sizePolicy1.setHeightForWidth(
            self.l_tasa_trans_h_m.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_tasa_trans_h_m.setStyleSheet(
            "background: none;\n"
            "border:none;\n"
            "color: rgba(44, 65, 76, 150);\n"
            "padding-right: 20px;\n"
        ...
        sizePolicy1.setHeightForWidth(
            self.l_tiempo_recuperacion.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_tiempo_recuperacion.setStyleSheet(
            "background: none;\n"
            "border:none;\n"
            "color: rgba(44, 65, 76, 150);\n"
            "padding-right: 20px;\n"
        ...
        sizePolicy1.setHeightForWidth(
            self.l_tiempo_incubacion.sizePolicy().hasHeightForWidth()
        )
        ...
        self.l_tiempo_incubacion.setStyleSheet(
            "background: none;\n"
            "border:none;\n"
            "color: rgba(44, 65, 76, 150);\n"
            "padding-right: 20px;\n"
        ...
        self.f_frame_ingresar_datos.setStyleSheet(
            "background-color: rgb(255, 255, 255);\n"
        ...
        sizePolicy18.setHeightForWidth(
            self.sb_humanos_infectados.sizePolicy().hasHeightForWidth()
        )
        ...
        self.sb_humanos_infectados.setStyleSheet(
            "color: rgb(44, 65, 76);\n"
        ...
        sizePolicy18.setHeightForWidth(
            self.sb_poblacion_mosquito.sizePolicy().hasHeightForWidth()
        )
        ...
        self.sb_poblacion_mosquito.setStyleSheet(
            "color: rgb(44, 65, 76);\n"
            "background-color: rgba(240, 244, 247, 125);\n"
            "border-radius: 8px;\n"
            "padding-left: 10px;\n"
        ...
        sizePolicy18.setHeightForWidth(
            self.sb_mosquitos_infectados.sizePolicy().hasHeightForWidth()
        )
        ...
        self.sb_mosquitos_infectados.setStyleSheet(
            "color: rgb(44, 65, 76);\n"
            "background-color: rgba(240, 244, 247, 125);\n"
            "border-radius: 8px;\n"
            "padding-left: 10px;\n"
        ...
        sizePolicy17.setHeightForWidth(
            self.cb_duracion_simulacion.sizePolicy().hasHeightForWidth()
        )
        ...
        self.cb_duracion_simulacion.setStyleSheet(
            "border-radius: 5px;\n"
            "background-color: rgba(240, 244, 247, 125);\n"
            "border-radius: 8px;\n"
            "padding-left: 10px;\n"
        ...
        sizePolicy18.setHeightForWidth(
            self.sb_duracion_dias.sizePolicy().hasHeightForWidth()
        )
        ...
        self.sb_duracion_dias.setStyleSheet(
            "color: rgb(44, 65, 76);\n"
            "background-color: rgba(240, 244, 247, 125);\n"
            "border-radius: 8px;\n"
            "padding-left: 10px;\n"
        ...
        sizePolicy18.setHeightForWidth(
            self.sb_tasa_transmision_h.sizePolicy().hasHeightForWidth()
        )
        ...
        self.sb_tasa_transmision_h.setStyleSheet(
            "color: rgb(44, 65, 76);\n"
            "background-color: rgba(240, 244, 247, 125);\n"
            "border-radius: 8px;\n"
            "padding-left: 10px;\n"
        ...
        sizePolicy18.setHeightForWidth(
            self.sb_dias_recuperacion.sizePolicy().hasHeightForWidth()
        )
        ...
        self.sb_dias_recuperacion.setStyleSheet(
            "color: rgb(44, 65, 76);\n"
            "background-color: rgba(240, 244, 247, 125);\n"
            "border-radius: 8px;\n"
            "padding-left: 10px;\n"
        ...
        sizePolicy18.setHeightForWidth(
            self.sb_tasa_muerte.sizePolicy().hasHeightForWidth()
        )
        ...
        self.sb_tasa_muerte.setStyleSheet(
            "color: rgb(44, 65, 76);\n"
            "background-color: rgba(240, 244, 247, 125);\n"
            "border-radius: 8px;\n"
            "padding-left: 10px;\n"
    ...
    def retranslateUi(self, objeto_inicial):
        objeto_inicial.setWindowTitle(
            QCoreApplication.translate("objeto_inicial", "Form", None)
        )
        ...
        self.label_2.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                '<html><head/><body><p align="center">Sin datos que vizualizar</p></body></html>',
                None,
            )
        )
        ...
        self.label.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                '<html><head/><body><p align="center"><span style=" font-size:12pt; color:#d0d4e4;">Esperando datos epidemiol\u00f3gicos</span></p></body></html>',
                None,
            )
        )
        ...
        self.label_44.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Estad\u00edsticas clave:</p></body></html>",
                None,
            )
        )
        self.label_26.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Ritmo de contagio general:</p></body></html>",
                None,
            )
        )
        self.l_ritmo_contagio_general.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_22.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Poblaci\u00f3n humana total:</p></body></html>",
                None,
            )
        )
        self.l_poblacion_humana_total.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_30.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Cantidad de muertos:</p></body></html>",
                None,
            )
        )
        self.l_cantidad_muertos.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_43.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Infectados acumulados:</p></body></html>",
                None,
            )
        )
        self.l_infectados_acumulados.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        ...
        self.label_17.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                '<html><head/><body><p align="center">Dias transcurridos</p></body></html>',
                None,
            )
        )
        self.l_contador.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                '<html><head/><body><p align="center">000</p></body></html>',
                None,
            )
        )
        ...
        self.label_45.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                '<html><head/><body><p align="center">Indicadores en tiempo real</p></body></html>',
                None,
            )
        )
        self.label_35.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Susceptibles humanos:</p></body></html>",
                None,
            )
        )
        self.label_33.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Expuestos humanos:</p></body></html>",
                None,
            )
        )
        self.label_31.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Infectados humanos:</p></body></html>",
                None,
            )
        )
        self.label_32.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Recuperados humanos:</p></body></html>",
                None,
            )
        )
        self.l_susceptibles_h.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.l_expuestos_h.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.l_infectados_h.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.l_recuperados.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_40.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Susceptibles mosquitos:</p></body></html>",
                None,
            )
        )
        self.label_41.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Expuestos mosquitos:</p></body></html>",
                None,
            )
        )
        self.label_42.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Infectados mosquitos:</p></body></html>",
                None,
            )
        )
        self.l_susceptibles_m.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.l_expuestos_m.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.l_infectados_m.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_55.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Resumen epidemiol\u00f3gico:</p></body></html>",
                None,
            )
        )
        self.label_56.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Tasa de transmisi\u00f3n M-H:</p></body></html>",
                None,
            )
        )
        self.l_tasa_trans_m_h.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_58.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Tasa de transmisi\u00f3n H-M:</p></body></html>",
                None,
            )
        )
        self.l_tasa_trans_h_m.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_60.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Tiempo de recuperaci\u00f3n:</p></body></html>",
                None,
            )
        )
        self.l_tiempo_recuperacion.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_62.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Tiempo de incubaci\u00f3n:</p></body></html>",
                None,
            )
        )
        self.l_tiempo_incubacion.setText(
            QCoreApplication.translate(
                "objeto_inicial", "<html><head/><body><p>000000</p></body></html>", None
            )
        )
        self.label_9.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Datos de la simulacion</p></body></html>",
                None,
            )
        )
        self.label_21.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                '<html><head/><body><p><span style=" font-size:11pt;">Configuraci\u00f3n de humanos</span></p></body></html>',
                None,
            )
        )
        self.label_12.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Humanos infectados:</p></body></html>",
                None,
            )
        )
        self.label_20.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Configuraci\u00f3n de mosquitos</p></body></html>",
                None,
            )
        )
        self.label_10.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Poblacion mosquito:</p></body></html>",
                None,
            )
        )
        self.label_11.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Mosquitos infectados:</p></body></html>",
                None,
            )
        )
        self.label_19.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Configuraci\u00f3n de la simulaci\u00f3n</p></body></html>",
                None,
            )
        )
        self.label_18.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Lugar de la simulacion:</p></body></html>",
                None,
            )
        )
        self.cb_lugar.setItemText(
            0, QCoreApplication.translate("objeto_inicial", "Punto Fijo", None)
        )
        self.cb_lugar.setItemText(
            1, QCoreApplication.translate("objeto_inicial", "AntiguoAeropuerto", None)
        )

        self.label_13.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Duracion de la Simulacion:</p></body></html>",
                None,
            )
        )
        self.cb_duracion_simulacion.setItemText(
            0,
            QCoreApplication.translate("objeto_inicial", "Final de la infeccion", None),
        )
        self.cb_duracion_simulacion.setItemText(
            1, QCoreApplication.translate("objeto_inicial", "Personalizado", None)
        )

        self.label_14.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Tasa de transmision:%</p></body></html>",
                None,
            )
        )
        self.label_15.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Dias de recuperacion:</p></body></html>",
                None,
            )
        )
        self.label_16.setText(
            QCoreApplication.translate(
                "objeto_inicial",
                "<html><head/><body><p>Tasa de muertes:%</p></body></html>",
                None,
            )
        )
